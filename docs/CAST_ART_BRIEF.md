...
> - 画風：レース竜V2と同じ3D調（`images/dragons/poro.png` と並べて同じ竜に見えること）。
> - 正本＝Higgsfield job `adc30bdc-ebf0-48f5-91e8-adc64184b427`（nano_banana_pro・参照はV2レース竜ポロ）。表情差分はこの job を参照して i2i。
