...
> **現況（2026-09-19）＝14曲＋当たり音3本、すべて揃った。実機で 17/17 の再生を確認済み。**
>
> 一時 `bgm/uibgm/` が空になっていたが、**曲は失われていなかった**。退避コミット `65362cf`
> （2026-08-25・`codex/title-logo-wiring` 上の「作業ツリー退避バックアップ」）に全ファイルが残っており、
> main を早送りした際に取り残されていたのが原因。`git checkout 65362cf -- bgm/uibgm/` で全量復旧した。
>
> 復旧ファイルに対して全サンプルで RMS を再測定し、`js/bgm.js` の TRACK_GAIN と
> **誤差 0.0〜0.1% で一致**することを確認（＝ゲイン表はこのファイル群から測られた正しい値・測り直し不要）。
>
> ★同定の注意：**RMS の近さで曲を同定しないこと。** 別曲である `home-morning`（0.1671）と
> `documentary`（0.1673）はほぼ一致する。Suno 出力は音量が近い値に集まるだけ。同定は ID3 タグで行う。

| # | ファイル | 優先 | 発注 | 納品 | 結線 | 実機確認 |
|---|---|---|---|---|---|---|
| T1 | title-konron | P0 | ✅ | ✅ | ✅ | ✅ 90秒・2026-09-19設置 |
| T2 | home-morning | P0 | ✅ | ✅ | ✅ | ✅ 90秒・2026-09-19設置 |
| T3 | home-onair | P0 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T4 | bet-lobby | P0 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T5 | documentary | P0 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T6 | island-life | P0 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T7 | konron-stroll | P1 | ✅ | ✅ | ✅ | ✅ 120秒・2026-09-19設置 |
| T8 | scout-stalk | P1 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T9 | poro-nap | P1 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T10 | after-race | P1 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T11 | timeline | P1 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T12 | onsen-uroko | P2 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T13 | doom-countdown | P2 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
| T14 | sacred-race | P2 | ✅ | ✅ | ✅ | ✅ 2026-09-19 復旧・実機確認 |
