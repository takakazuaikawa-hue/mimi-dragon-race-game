...
const KW_AREAS = {
  ...
  onsen: {
    ...
    doors: [
      ...
      { c: 22, r: 17, ic: "🏖️", n: "浜へくだる道", hint: "潮の匂いのする方へ", area: "beach" },
  ...
  beach: {
    ...
    doors: [
      { c: 7, r: 4, ic: "📷", n: "桟橋の先", hint: "写真をとる", stay: true,
        go: function () { kwShoot("sena"); } },
      { c: 21, r: 13, ic: "🍧", n: "かき氷の屋台", hint: "食べていく",
        go: function () { if (typeof renderMeals === "function") renderMeals(); } },
      { c: 2, r: 19, ic: "♨️", n: "温泉郷へもどる道", hint: "坂をのぼる", area: "onsen" },
      { c: 29, r: 19, ic: "🏝️", n: "島の地図へ", hint: "この日の島時間をとじる",
        go: function () { if (typeof renderKonronMap === "function") renderKonronMap(); } },
    ],
    npcs: [
      { c: 12, r: 12, s: 2, line: "この浜はな、夕方になると波の音がいちばん静かになる。" },
      { c: 24, r: 16, s: 3, line: "貝がら、いっぱい拾ったよ！　ほら、これ竜のかたち！" },
    ],
  },
};
