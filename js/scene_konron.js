  ...
  city: {
    ...
    npcs: [
      ...
      { c: 12, r: 17, s: 1, line: "市場の湯気、いい匂いでしょう。つい寄っちゃうのよね。",
        // ★うわさ：昼の炭火（焼きとうもろこし）は、この刻にしか立たない。
        linesByTime: { "宵": "宵の市場が本番よ。提灯に火が入ると、値段より先に匂いで選んじゃうの。", "未明": "こんな時間に？　……まあ、仕込みの湯気だけは、もう立ってるけどね。", "昼": "昼はね、炭を焼く煙が上がるの。あの甘い焦げの匂いがしたら、もう並んだほうがいいわよ。" } },
  ...
  race: {
    ...
    doors: [
      ...
      { c: 21, r: 16, ic: "🍢", n: "場外の屋台", hint: "食べていく", stay: true,
        // 刻で品揃えが替わる（未明=焼き鳥だけ／朝昼=だんご・ドッグ／夕暮れ=どて煮も／宵夜=ラーメン）
        go: function () { kwStall("🍢 場外の屋台", ["t_yakitori", "t_dog", "t_dango", "t_dote", "t_ramen"]); } },
    ...
    npcs: [
      ...
      { c: 23, r: 16, s: 0, line: "本日の第一。荒れますよ、この風は。",
        // ★うわさ（2026-08-02）：場所×刻をそっと教える。告知はしない＝聞いた人だけが得をする側。
        linesByTime: { "未明": "この時間はな、走路の手入れだ。ならしたばかりの土は、踏むのがもったいない。", "宵": "終わったあとの砂を掃くのが、いちばん静かな仕事でね。", "夜": "夜まで残るなら、場外のラーメンだ。あれは陽が落ちてからしか出ん。背脂が、な。" } },
    ],
  },
  ...
  onsen: {
    ...
    npcs: [
      ...
      { c: 17, r: 17, s: 1, line: "ここのお湯、竜の鱗にも効くんですって。",
        // ★うわさ：湯上がりの甘酒は休憩処にいつでもある（刻を選ばない品もある、という手がかり）。
        linesByTime: { "未明": "一番湯、いま張ったばかり。まだ湯船に、湯気しかいませんよ。", "夕暮れ": "夕方は湯の色が変わるんです。……ほんとうは、空の色ですけどね。", "宵": "湯から上がったら、休憩処へどうぞ。麹の甘いのを、いつでもお出ししていますよ。" } },
    ],
  },
