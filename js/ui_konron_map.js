...
const KONRON_SPOTS = {
  ...
  kirimina:  { name: "霧港",             cat: "port", tier: 1, time: "夕〜夜", gourmet: "images/konron/spots/kirimina_gourmet.webp", shoot: "提灯と漁船・港の屋台・干物と小舟", line: "潮の匂いと提灯の灯りが混ざる、崑崙島の生活の入口。" },
  ...
  kachimeshi:{ name: "勝ち飯横丁",       cat: "food", tier: 1, portal: "renderMeals", time: "レース後", gourmet: "images/konron/spots/kachimeshi_gourmet.webp", shoot: "的中券と串焼き・祝勝皿・乾杯", line: "大勝ちじゃなくても今日は勝ち。ちょっとだけ豪華に。" },
  makemeshi: { name: "負け飯屋台",       cat: "food", tier: 0, portal: "renderMeals", time: "レース後〜夜", gourmet: "images/konron/spots/makemeshi_gourmet.webp", shoot: "外れ券と大盛り飯・反省茶・負け麺", line: "負けても腹は減る。明日の勝負は、まず一杯の飯から。" },
  ...
  uroko:     { name: "ウロコトロ温泉郷", cat: "onsen", tier: 1, time: "夕〜夜", gourmet: "images/konron/spots/uroko_gourmet.webp", shoot: "湖畔の露天風呂・湯けむり・温泉街の灯り", line: "湯けむりと湖畔の静けさにほどける、火山島のご褒美時間。" },
  kibishis:  { name: "キビシス崖線",     cat: "view", tier: 2, time: "昼〜午後", shoot: "海へ落ちる崖・風の展望台・翼竜の遠い影", line: "空が近い。ここは翼のための場所。息を呑むスケール。" },
  sena:      { name: "サナ湾／セナ浜",   cat: "view", tier: 2, time: "昼", gourmet: "images/konron/spots/sena_gourmet.webp", shoot: "白砂とラグーン・ミストラソーダ・ファイヤマンゴーアイス", line: "白砂と青い海、旅気分が一気に高まる開放的ビーチ。" },
