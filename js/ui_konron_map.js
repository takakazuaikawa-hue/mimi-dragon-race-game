...
function _kmOnsenMizuScript(s) {
  ...
  return [
    ...
    { s: "mizu", t: "……平和といえば。むかし、一着が三頭ならんだ日があってね。" },
    { s: "mimi", e: "panic", t: "三頭!?　……そんなこと、あるんですか。" },
    { s: "mizu", t: "写真判定でも分けられなかったの。三頭とも一着。——同着よ。" },
    { s: "mimi", t: "……じゃあ、だれが勝ったんですか？" },
    { s: "mizu", t: "三頭とも。……つまり、その三頭に賭けた人は、ぜんぶ当たり。" },
    { s: "mizu", t: "そのぶん配当は三つに割れて、ぺしゃんこ。当てても、たいして増えなかったわ。" },
    { s: "mimi", t: "えー。せっかく当てたのに。" },
    { s: "mizu", t: "でもね。あの日はね、当たった人がいちばん多かったのよ。あはん。" },
    { s: "narrator", t: "ミズが湯をすくって、ぱしゃりと落とした。" },
    { s: "mizu", t: "ふつうの日は、勝つのはひとり。……あの日だけは、だれの答えも正解だったの。" },
    { s: "mimi", t: "……なんか、いいですね。それ。" },
    { s: "mizu", t: "そうね。……あたくしも、あの日の帳場は、きらいじゃなかったわ。" },
