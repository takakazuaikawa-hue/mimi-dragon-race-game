...
function _kmOnsenMizuScript(s) {
  ...
  return [
    ...
    { s: "mizu", t: "……平和といえば。むかし、一着がならんだ日があってね。" },
    { s: "mimi", e: "panic", t: "ならんだ？　……写真判定、ってやつですか。" },
    { s: "mizu", t: "その写真判定でも、分けられなかったの。——同着よ。" },
    { s: "mimi", t: "……じゃあ、配当ってどうなるんですか？" },
    { s: "mizu", t: "1.0倍。……賭けたぶんが、そのまま返ってくるだけ。" },
    { s: "mimi", t: "えっ。当てたのに、増えないんですか。" },
    { s: "mizu", t: "ええ。この島の決まりなの。……同着はね、竜の名誉にも、勝敗にもならないから。" },
    { s: "narrator", t: "ミズが湯をすくって、ぱしゃりと落とした。" },
    { s: "mizu", t: "勝った竜も、負けた竜も、いない。……だからその日は、だれも勝たないし、だれも負けないの。" },
    { s: "mimi", t: "……なんか、やさしいですね。それ。" },
    { s: "mizu", t: "そうね。……あたくしも、きらいじゃないわ。" },
