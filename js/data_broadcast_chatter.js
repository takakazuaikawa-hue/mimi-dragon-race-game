...
const BC_CHATTER = [
  ...
  { id: "makura_gourmet_05", cm: "makura", topic: "gourmet", at: "mid", line: "汁物の屋台さ、器が熱すぎて毎回持てないの。学習しないオレ。" },
  ...
  { id: "makura_life_05", cm: "makura", topic: "life", at: "entry", line: "オレさ、来週から早起きするって決めたんだよ。決めただけ。" },
  ...
  { id: "makura_pun_02", cm: "makura", topic: "pun", at: "mid", line: "布団が吹っ飛んだ。……え、なんでオレ今これ言った？" },
  { id: "makura_pun_03", cm: "makura", topic: "pun", at: "mid", line: "……はくしょん。ごめん、以上です。何も言うことない。" },
  { id: "makura_pun_04", cm: "makura", topic: "pun", at: "entry", line: "カレー食べたい。以上。オレの話、だいたいこれなんだよね。" },
  ...
  { id: "celestia_dragon_05", cm: "celestia", topic: "dragon", at: "mid", line: "竜の寿命は星の瞬きほど。我にはそう見えるのね。" },
  { id: "celestia_dragon_06", cm: "celestia", topic: "dragon", at: "entry", line: "アカネの目は、朝焼けを千回見た者の色をしているのよ。" },
  { id: "celestia_dragon_07", cm: "celestia", topic: "dragon", at: "entry", line: "竜の翼の骨はね、我らの指と同じ数だけあるのよ。ふふ。" },
  ...
  { id: "celestia_history_06", cm: "celestia", topic: "history", at: "mid", line: "この祭りの起源はね、誰も覚えていないのよ。我も少し。" },
  ...
  { id: "celestia_gourmet_04", cm: "celestia", topic: "gourmet", at: "mid", line: "海藻の煮物はね、我はいくらでも食べられるのよ。" },
  ...
  { id: "celestia_gourmet_07", cm: "celestia", topic: "gourmet", at: "mid", line: "冷たい麺をね、我は少しだけ長く噛むのが好きなのよ。" },
  { id: "celestia_life_01", cm: "celestia", topic: "life", at: "mid", line: "我はね、今朝から左の肩が少しだけ重いのよ。ふふ。" },
  ...
  { id: "celestia_life_05", cm: "celestia", topic: "life", at: "mid", line: "我の袖はね、風があると少しだけ邪魔になるのよ。" },
  ...
  { id: "celestia_life_10", cm: "celestia", topic: "life", at: "entry", line: "島の子らはね、我を見ると必ず手を振るのよ。嬉しいこと。" },
  { id: "celestia_pun_01", cm: "celestia", topic: "pun", at: "mid", line: "竜が立つ。……我は今、何か言った気がするのね。ふふ。" },
  ...
  { id: "celestia_pun_04", cm: "celestia", topic: "pun", at: "mid", line: "霧が濃い。濃い霧。……我には同じに聞こえるのね。" },
  { id: "unme_dragon_01", cm: "unme", topic: "dragon", at: "mid", line: "竜って寝相が悪いんですって。知らんけど！" },
  { id: "unme_dragon_02", cm: "unme", topic: "dragon", at: "entry", line: "バランは朝が弱いって、わたくし知ってましたよぉ。" },
  ...
  { id: "unme_dragon_06", cm: "unme", topic: "dragon", at: "entry", line: "ポロはよく泣くんですって。わたくしも昔そうでしたぁ。" },
  ...
  { id: "unme_course_06", cm: "unme", topic: "course", at: "entry", region: "ヴェント峡谷地域", line: "ここの風、帽子を三つ持っていかれましたわたくし。" },
  ...
  { id: "unme_island_05", cm: "unme", topic: "island", at: "mid", line: "島の南のほう、まだ行ったことないんですよぉわたくし。" },
  ...
  { id: "unme_history_07", cm: "unme", topic: "history", at: "mid", line: "古い石碑の字、誰も読めないんですって。わたくしも無理！" },
  ...
  { id: "unme_gourmet_04", cm: "unme", topic: "gourmet", at: "mid", line: "屋台の汁物、猫舌のわたくしには早すぎますぅ。" },
  { id: "unme_gourmet_05", cm: "unme", topic: "gourmet", at: "entry", line: "冷たい麺に熱い茶、この組み合わせ発明したのわたくし。" },
  ...
  { id: "unme_life_02", cm: "unme", topic: "life", at: "entry", line: "この髪型、朝に十分かけてるんですって。わたくしがです。" },
  { id: "unme_life_03", cm: "unme", topic: "life", at: "mid", line: "履物の紐、今朝ほどけて三回結び直しましたぁ。" },
  { id: "unme_life_04", cm: "unme", topic: "life", at: "entry", line: "実はわたくし、こう見えて肩こりがひどいんですよぉ。" },
  ...
  { id: "unme_life_08", cm: "unme", topic: "life", at: "entry", line: "わたくし、寒いのが苦手でしてぇ。暑いのも苦手ですぅ。" },
