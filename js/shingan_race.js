...
const SHINGAN_ROSTER = [
  ...
  { id: "fugaku", loc: "cliff",   locName: "崖",       ic: "🪨",
    q: "不動", qd: "登りは島いちばん（×1.14）。降りは苦手（×0.96）。順位にも差にも反応しない、動かざること山。",
  ...
  { id: "glaze",  loc: "sea",     locName: "水中",     ic: "❄️",
    q: "氷甲の冷気", qd: "前後0.8秒にいる他の竜のクセの振れ幅を半分にする（×0.5）。自分は順位にも差にも反応しない（×1.00）。荒ぶる竜ほど、よく冷える。",
  ...
  { id: "poro",   loc: "poro",    locName: "相棒",     ic: "💧",
    q: "涙の伴走", qd: "先頭との差が0.5秒以内なら泣きながら食らいつく（×1.07）。離されると心が折れる（×0.96）。置いていかれるのが、いちばん怖い。",
