...
const STORY_CHAPTERS = [
  ...
  { id: "ED", level: 5, cast: "celestia", title: "エンディング　次の物語へ",
    ...
    body: "エンディング：ド級の隕石を落とされた夜、私は勝つ竜の名を知っただけで勝った気になっていた自分を団子ごと飲み込み、単竜では薄くなりすぎた正解のまわりに、複竜で残る席を探し、ワイド竜でまだ沈んでいない組み合わせを拾い、オッズの端に残った小さな歪みまでかき集めて、これが私の全部ですと震える手で最後の賭け札を切り直し、夜明け前の聖龍レース場にもう一度だけ歓声を爆発させたことで、絶滅のブラックメテオに、この賭場、壊れなかったね、と少しだけ嬉しそうに去られ、霧と火山の島は朝まで灯りの消えない聖龍レースリゾートへ育ち、最後のレースを走り切った竜たちがなぜか全員こっちを見て鳴いたので、え、これもしかして祝福ですか、請求書じゃなくて？ と震えていたら本当に聖龍の加護が降り、屋台も宿も竜舎も観覧席もまとめて総資産に化けていく中、これもう借金返済どころか島ごと決算書に載ってない？ という怖すぎる現実と、けたを数えるのを途中であきらめた資産を抱え、あの日レース場の入口で拾われた私は、今度は自分で島の出口を選び、朝の桟橋から霧の向こうの次の物語へ再出発する件。" }
];
