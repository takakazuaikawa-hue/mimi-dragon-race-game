...
function renderHome() {
  ...
  const _BANTER = ["今日はどの竜を推す〜？", "コメントありがとっ！", "いっしょに当てようね！", "耳、さわっていいよ？ うそうそ。", "オッズ、よーく見てね。", "ぱほぱほ〜♪", "推し竜、見つかった？", "差し入れ、うれしいな♪",
    "今日も来てくれてうれしいっ", "むずかしいレースほど燃えちゃう！", "本命か、穴か……ドキドキだね", "わたしの勘、当たるかな…？", "みんなの応援がパワーだよ！", "次のレース、いっしょに読も？", "ぱほっ！気合い入れてこ〜", "オッズは正直だからね、ふふ",
    "こつこつ当てて、いい暮らししたいな", "竜たち、今日もかっこいいなぁ", "耳がぴくって鳴ると当たる予感…！", "しっぽ、揺れちゃう〜♪", "はぁ…緊張する。でもたのしい！", "コメント全部読んでるからね？", "差し入れの匂いにつられちゃう…", "村のみんな、元気かな〜",
    "夢は大きく、賭けは慎重に！", "きょうのラッキー竜、どの子だろ？", "わたし、まだまだ伸びるよっ", "見ててね、絶対に当てるから！", "ひと息ついて、次いこ〜", "その一票、大事にするねっ"];
  ...
  const _MIMI_SAY = ["わっ、見てくれてるの…？ えへへ。", "今日もいっしょにドキドキしよ？", "コメント、ぜんぶ読んでるよ！", "ぱほぱほ〜♪", "耳、さわっちゃだめ……ちょっとだけならいいかも？", "この世界、まだ慣れないけど…がんばるっ！", "次はどの子に賭けようかな…", "応援、すっごく力になるんだ！", "わたし、予想家ミミです。よろしくねっ", "ふぁ…ちょっとねむい、かも？",
    "そんなに見つめられると…照れちゃう。", "きょうも一日、よろしくねっ", "わたしね、諦めが悪いんだ。ふふ", "当てたら、いっしょに喜んでね？", "ぱほっ！元気でた〜", "むむ、このオッズ…あやしいなぁ", "ちょっと自信ある予想、あるんだ…！", "耳、ぴくぴくしてる？ 好調のあかし！",
    "はずしても、次で取り返すもんっ", "みんなのおかげで、ここまで来れたよ", "しっぽ、なでていいよ…なんてね", "おなかすいた…あとで屋台いこ？", "がんばるわたし、かっこいい？えへへ", "この島の風、気持ちいいねぇ", "きみの一票、しっかり見てるよ", "また会えてうれしい。ぱほ〜♪"];
  function _mimiTalk() {
  ...
  // ★視聴者名は絵文字つき“ハンドル”で個性を出す（原本の顧問/入場/ギフトが絵文字名なのに合わせる）。
  //   🌟(入場)🎁(ギフト)は予約なので回避。名前は _addCm 側で色付き<b>に装飾される。
  const _CMN = ["🐲竜見の村人", "🎀観客アヤ", "🍶常連のジジ", "🎩旅の予想屋", "🐰バニー推し", "🏝️島っ子", "🍢屋台のおやじ", "🌙夜勤あけ", "✈️遠征組", "🔰はじめて見た",
    "🐉竜舎の常連", "🧒村の子ども", "📓予想ノート勢", "📷観光客さん", "🎖️ベテラン勢", "🍜屋台の常連", "👀通りすがり", "🔮町外れの占い師",
    "⚓港のあんちゃん", "🌸花屋のミオ", "😺眠り猫さん", "💸崖っぷち勢", "📅毎日通う人", "👑元・大穴王", "🤫静かに応援", "🌴南国かぶれ", "💦そわそわ勢", "♨️湯上がりの人", "🙌パホパホ団", "🌃深夜のリスナー"];
  ...
  const _CMT = ["ミミちゃん今日も推す！", "初見です！よろしく！", "🐲🐲🐲", "ぱほぱほ〜！", "今日こそ波乱こい", "本命党です", "穴党ですが何か", "耳ぴょこぴょこかわいい", "その衣装どこで買ったの？", "レースまだかな", "🔥🔥🔥", "💖💖", "ポロちゃん推し", "オッズ見てから来た", "村から応援してます", "🥕どうぞ", "昨日の波乱すごかった", "おやつ持ってきた", "今日の本命教えて", "かわいいの域を超えてる",
    ...
    "うおおおキタキタキタ", "全ツッパいっきまーす！", "本命様、どうか…！🙏", "手が震える（武者震い）", "この配当で焼肉いくぞ", "心臓に悪い、もっとやって", "勝ち確の顔してるって", "叫んでいい？ もう叫ぶわ", "最終直線で毎回立ち上がる", "はいアドレナリン出た",
    "かわいすぎて咳き込んだ", "尊さで画面がまぶしい", "耳ぴょこで寿命のびた", "はい優勝（ミミが）", "笑顔の暴力やめて（もっと）", "今日も顔がいい、ありがとう", "沼が深い、もう戻れない", "ミミに人生あずけたい",
    "また外した、負ける才能ある", "給料、ミミに溶けました", "貯金は心の中にあります", "本命買うと穴、穴買うと本命", "財布が軽い＝身軽ってこと", "来月の家賃と相談中", "外れ待ちのプロが通りますよ", "お小遣い一瞬で蒸発した", "負けても構文で笑えるヨシ",
    "解説うますぎて逆に怪しい", "その自信どこから？（好き）", "正座して見てます", "通知きた瞬間ダッシュした", "無言でハート連打しがち", "コメント拾われたら勝てる説", "今の予想、天才では…？", "また名言、メモしとこ", "初見です、たぶん沼る",
    "🐲🔥🐲🔥", "ぱほぱほぱほ！！", "🥕🥕🥕", "😭✨うれし泣き", "＼ミミ／＼ミミ／", "💰→🕊️ サヨナラ資金", "🙏🙏🙏",
    "崑崙モールで散財した帰り", "竜まん食べながら観戦", "港から双眼鏡で見てる", "島じゅうが見てる説ある", "温泉あがりにひとレース",
    "無言勢だけど皆勤賞です", "友達に布教してきた", "この民度、天国か？", "みんな優しくて涙", "新規です、よろしくどうぞ", "推し竜よ、爆走しろ〜！", "ここが今日いちばん平和"];
