...
function renderHome() {
  ...
  const _CMT = ["ミミちゃん今日も推す！", "初見です！よろしく！", "🐲🐲🐲", "ぱほぱほ〜！", "今日こそ波乱こい", "本命党です", "穴党ですが何か", "耳ぴょこぴょこかわいい", "その衣装どこで買ったの？", "レースまだかな", "🔥🔥🔥", "💖💖", "ポロちゃん推し", "オッズ見てから来た", "村から応援してます", "🥕どうぞ", "昨日の波乱すごかった", "おやつ持ってきた", "今日の本命教えて", "かわいいの域を超えてる",
    ...
    "仕事帰りに寄りました", "この配信が一日の楽しみ", "ミミちゃんの声すき", "今日は堅く三連単？", "オッズ妙味あるレースきた", "単勝か複勝か…相談したい", "予想ノート付けてます📓", "先週の的中、神だった", "まさかの大穴、信じてた人〜？", "ミミちゃんの笑顔で回復した",
    "しっぽふりふりかわいい", "耳がレーダーみたい🐰", "パホパホの意味未だ分からず好き", "今日の島、天気よさそう", "屋台の焼き竜まん食べたい", "港に新しい竜きたらしい", "ミミちゃん無理しないでね", "水分とってる〜？", "配信の合間もかわいい", "次の休みは崑崙モール行こ",
    "この人の予想で勝ち越してる", "初心者にもやさしい実況すき", "ミミ語録メモしてる", "推し変しそう（ミミに）", "村のみんなで見てるよ", "今日のコーデ最高", "髪型もかわいい〜", "がんばりが伝わってくる", "また名言でた", "ぱほっ！って言うとこ好き",
    "手に汗にぎる展開たのむ", "堅実に勝ってこ〜", "夢の万馬券いこう！", "きょうも平常運転で安心する", "ミミちゃんのおかげで島好きになった", "遠征先から見てます", "深夜組、集合〜🌙", "眠いけど最後まで見る", "推し竜が走ると叫んじゃう", "みんな仲良くてすき",
    "コメント拾ってくれてうれし", "はじめて当てました！ありがと", "負けても雰囲気よくて助かる", "ここのファン、あったかい", "今日の一頭、直感で決めた", "ミミちゃんの直感、当たるよね", "また明日も来ます", "毎日の癒やし枠", "この島に住みたくなる", "ずっと応援してるからね"];
