...
var STORY_EVENTS = [
  ...
  { id: "se_mizu_deadheat", ic: "♨️", who: "ミズ", color: "#5aa0d0", cast: "mizu",
    ...
    body: "ウロコトロ温泉郷。湯けむりの向こうで、湖の灯りが揺れていた。\n「ん〜〜〜っ、平和だね〜」\n「……ほんと。平和だわ〜」\nしばらく、湯の音だけ。\n「……平和といえば。むかし、一着が三頭ならんだ日があってね」\n三頭!?　……そんなこと、あるんですか。\n「写真判定でも分けられなかったの。三頭とも一着。——同着よ」\n……じゃあ、だれが勝ったんですか？\n「三頭とも。……つまり、その三頭に賭けた人は、ぜんぶ当たり」\n「そのぶん配当は三つに割れて、ぺしゃんこ。当てても、たいして増えなかったわ」\nえー。せっかく当てたのに。\n「でもね。あの日はね、当たった人がいちばん多かったのよ。あはん」\nミズが湯をすくって、ぱしゃりと落とした。\n「ふつうの日は、勝つのはひとり。……あの日だけは、だれの答えも正解だったの」\n……なんか、いいですね。それ。" },
