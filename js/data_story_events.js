...
var STORY_EVENTS = [
  ...
  //   中盤（12戦）に置く＝最終決戦まで遠く離れていて、思い出すころには自分の発見になる。
  { id: "se_mizu_deadheat", ic: "💧", who: "ミズ", color: "#5aa0d0", cast: "mizu",
    title: "決着のつかなかった日", unlock: function () { return _seRaces() >= 12; },
    body: "帳場の奥で、ミズが古い帳面をめくっていた。\n「ねえ、ミミ。……この頁、面白いのよ」\n指の先に、二頭ぶんの名前が並んでいる。同じ行に、同じタイムで。\n「昔ね、ゴールが完全に並んだの。写真判定でも分けられなくて——同着」\nそれで、どっちが勝ちになったんですか？\n「どっちも。……というより、どちらでもなかったわ」\n扇子が、ぱちんと閉じた。\n「順位が決まらないと、賭けは成立しないの。だからその日は、ぜんぶそのままお返し。払い戻しよ」\nえっ。じゃあ、胴元は。\n「一銭も取れない。あはん」\n帳面の、数字がひとつも書かれていない頁を、ミズは指でとんとんと叩いた。\n「あの日だけはね。……この賭場、だあれも勝てなかったのよ」" },
