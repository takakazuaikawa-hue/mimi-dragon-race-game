...
var STORY_EVENTS = [
  ...
  // ★終章（神眼レース＝三頭同着）の伏線。ここでは戦術ではなく「昔そういう日があった」という
  //   帳場の歴史として置く。セレスティアにも最終決戦にも一切触れない＝答えを先出ししない。
  //   語り手がミズなのは、同着＝市場が決着を出せない事態が彼女の領分そのものだから
  //   （持ちネタ「値段は、ものの良さじゃなく“事情”でできてる」の延長）。
  //   ★きっかけは「12戦」ではなく**ウロコトロ温泉郷に初めて行った日**（ui_konron_map.js の
  //     _kmMaybeOnsenDeadheat が湯けむりVNを流し、onsenDeadheatHeard を立てる）。
  //     ここはその読み返し＝あとから何度でも引ける記録。
  { id: "se_mizu_deadheat", ic: "♨️", who: "ミズ", color: "#5aa0d0", cast: "mizu",
    title: "湯けむりと、決着のつかなかった日", unlock: function () { return _seFlag("onsenDeadheatHeard"); },
    body: "ウロコトロ温泉郷。湯けむりの向こうで、湖の灯りが揺れていた。\n「ん〜〜〜っ、平和だね〜」\n「……ほんと。平和だわ〜」\nしばらく、湯の音だけ。\n「……平和といえば。むかし、この島が一日だけ、まるごと止まった日があるのよ」\nえ、こわい。なんですかそれ。\n「ゴールが、完全に並んだの。写真判定でも分けられなくて——同着」\n……それで、どっちが勝ちになったんですか？\n「どっちも。……というより、どちらでもなかったわ」\n「順位が決まらないと、賭けは成立しないの。だからその日は、ぜんぶそのままお返し。払い戻しよ」\nえっ。じゃあ、胴元は。\n「一銭も取れない。あはん」\n「帳面のその頁だけ、数字がひとつも入っていないの。……あの日だけはね。この賭場、だあれも勝てなかったのよ」\n……なんだか、へんなの。だれも勝ってないのに、平和な話に聞こえた。" },
