...
const LIVING_RANKS = [
  ...
  //     いまの形＝マン／成金／主／見習い／卒業／おじさん／セリフ／擬音／短文／短文。
  { lv: 1,  title: "ドロミズすすりマン", note: "ミミズが食べ物に見える。公園の水がごちそう。ここから始まる。" },
  { lv: 2,  title: "フトン成金",         note: "床じゃなく布団で寝られる。電球を全部つけても怒られない。" },
  { lv: 3,  title: "冷蔵庫の主",         note: "自分の冷蔵庫とフライパン。卵をカップ麺に落とせる身分。" },
  { lv: 4,  title: "バカンス見習い",     note: "リゾートで数日。タクシーを“足”と呼びはじめた。" },
  { lv: 5,  title: "もやし卒業",         note: "もやし以外の野菜を買う。ちゃんとしたベッドで朝を迎える。" },
  ...
  { lv: 8,  title: "鍵束じゃらじゃら",   note: "庭付きの家に、海の見える別荘。帰る場所が増えすぎた。" },
