...
const LIVING_RANKS = [
  //   ★称号は「一目で暮らしぶりが浮かぶ物」に揃える（抽象語・意味が二通りに取れる語は使わない）。
  //     寝床が 床→布団→ベッド、旅が ひとり→家族と、住まいが 家→別荘→豪邸 と段を追って伸びる。
  { lv: 1,  title: "ドロミズすすりマン", note: "ミミズが食べ物に見える。公園の水がごちそう。ここから始まる。" },
  { lv: 2,  title: "布団で寝る人",       note: "床じゃなく布団で眠れる。電球を全部つけても平気。" },
  { lv: 3,  title: "冷蔵庫のある人",     note: "自分の冷蔵庫とフライパン。卵をカップ麺に落とせる。" },
  { lv: 4,  title: "温泉に行ける人",     note: "一泊の旅を即決できる。行き先を自分で選べる暮らし。" },
  { lv: 5,  title: "ベッドで寝る人",     note: "ちゃんとしたベッド。洗濯機が回る。朝がしんどくない。" },
  ...
  { lv: 7,  title: "回らない寿司の客",   note: "値段を見ずに頼める。行きつけの店に名前がある。" },
  { lv: 8,  title: "別荘を持つ人",       note: "庭付きの家に、海の見える別荘。帰る場所がいくつもある。" },
  { lv: 9,  title: "丘の上の住人",       note: "丘の上の豪邸。島のどこからでも、あの灯りが見える。" },
  { lv: 10, title: "空と島を持つ者",     note: "宇宙旅行の予約が取れる。この島で、それ以上は無い。" }
];
