...
const LIVING_RANKS = [
  ...
  { lv: 2,  title: "拾わない人",         note: "椅子を拾わずに買えた。床ではなく布団で眠れる。" },
  { lv: 3,  title: "卵を落とせる女",     note: "カップ麺に卵。冷蔵庫がある。腹を空かせて寝ない。" },
  { lv: 4,  title: "温泉に行ける人",     note: "一泊の旅を即決できる。行き先を自分で選べる暮らし。" },
  { lv: 5,  title: "ベッドで寝る人",     note: "ちゃんとしたベッド。洗濯機が回る。朝がしんどくない。" },
  { lv: 6,  title: "連れて行ける人",     note: "家族や友を旅行に誘える。ペットを迎える余裕もある。" },
  { lv: 7,  title: "回らない寿司の客",   note: "値段を見ずに頼める。行きつけの店に名前がある。" },
  { lv: 8,  title: "庭のある暮らし",     note: "庭付きの家。海の見える別荘も、もう夢ではない。" },
