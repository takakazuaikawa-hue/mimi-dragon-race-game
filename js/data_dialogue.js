...
(function (global) {
  ...
  var DLG = {
    ...
    CHAPTER: {
      ...
      "2": [
        { s: "mizu", t: "ねえ。あなたが昨日握りつぶした8.2倍、あれ、いくらの価値があったと思う？" },
      ...
      "3": [
        { s: "sumika", t: "ミミ様。本日、届け出が2件ございます。……1件は住所不定の是正勧告。もう1件は——わたくしからの、お願いです。" },
      ...
      "ED": [
        { s: "mimi", t: "ふー……。走って、賭けて、食べて。……ぜんぶ、やりきった！", e: "happy", fx: "hop" },
