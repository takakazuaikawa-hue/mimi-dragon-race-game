...
function renderHelp() {
  ...
  app.appendChild(section("deadheat", "同着になったら", [
    ...
    "同着でも賭けが無効になるわけではありません。<b>並んだ竜はすべて的中</b>になり、配当のもとになるお金を<b>頭数で分け合います</b>。だから一頭あたりの配当は下がります。",
    "外れた票は戻りません（返還はレース中止・出走取消のときだけ）。……つまり同着の日は、<b>当たる人がいちばん多く、ひとりぶんの取り分がいちばん小さい</b> 日です。"
  ]));
